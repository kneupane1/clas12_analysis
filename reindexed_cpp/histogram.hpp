...
void Fill_W_2pi_thrown(double W, double W_dpp, double delta_zero_,
                       double rho_, float weight);
...
void Fill_W_vs_Q2_thrown(double w, double q2, double wt);
...
void Fill_theta_P_lab_inv_mass_thrown(float inv_mass, float theta_lab, float wt);
void Fill_theta_pim_lab_inv_mass_thrown(float inv_mass, float theta_lab, float wt);
void Fill_theta_pip_lab_inv_mass_thrown(float inv_mass, float theta_lab, float wt);
